...
.method public addMiuiConnectResult(ILandroid/net/metrics/MiuiTcpRecordParams;)V
    .registers 6
    ...
    iget-wide v1, p0, Landroid/net/metrics/NetworkMetrics;->transports:J

    invoke-direct {v0, p1, v1, v2}, Landroid/net/metrics/NetworkMetrics$Summary;-><init>(IJ)V
    ...
    invoke-virtual {v0, p2}, Landroid/net/metrics/ConnectStats;->addConnectEvent(Landroid/net/metrics/MiuiTcpRecordParams;)V

    return-void
.end method

.method public addMiuiDNSResult(ILandroid/net/metrics/MiuiDnsRecordParams;)V
    .registers 6
    ...
    invoke-virtual {v0, p2}, Landroid/net/metrics/ConnectStats;->addDnsEvent(Landroid/net/metrics/MiuiDnsRecordParams;)V
...
.method public addTcpStatsResult(IIII)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/net/metrics/ConnectStats;->addTcpEvent(III)V
