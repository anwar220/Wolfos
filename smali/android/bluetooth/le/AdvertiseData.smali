...
.field private final mTransportDiscoveryData:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.method private constructor <init>(Ljava/util/List;Ljava/util/List;Ljava/util/List;Landroid/util/SparseArray;Ljava/util/Map;ZZ)V
    .registers 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method synthetic constructor <init>(Ljava/util/List;Ljava/util/List;Ljava/util/List;Landroid/util/SparseArray;Ljava/util/Map;ZZLandroid/bluetooth/le/AdvertiseData-IA;)V
    .registers 9
...
.method public getTransportDiscoveryData()Ljava/util/List;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
