...
.method public static asInterface(Landroid/os/IBinder;)Landroid/bluetooth/IBluetoothOobDataCallback;
    ...
    check-cast v1, Landroid/bluetooth/IBluetoothOobDataCallback;

    return-object v1

    :cond_14
    new-instance v1, Landroid/bluetooth/IBluetoothOobDataCallback$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/bluetooth/IBluetoothOobDataCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_9  #0x1
    const-string/jumbo v0, "onOobData"
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, v2}, Landroid/bluetooth/IBluetoothOobDataCallback$Stub;->onError(I)V
    ...
    sget-object v3, Landroid/bluetooth/OobData;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, v3}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroid/bluetooth/OobData;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, v2, v3}, Landroid/bluetooth/IBluetoothOobDataCallback$Stub;->onOobData(ILandroid/bluetooth/OobData;)V
