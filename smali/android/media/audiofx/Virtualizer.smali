...
# direct methods
.method static bridge synthetic -$$Nest$fgetmParamListener(Landroid/media/audiofx/Virtualizer;)Landroid/media/audiofx/Virtualizer$OnParameterChangeListener;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmParamListenerLock(Landroid/media/audiofx/Virtualizer;)Ljava/lang/Object;
    .registers 1
...
.method private static deviceToMode(I)I
    ...
    :pswitch_3  #0xf, 0x10, 0x11, 0x12, 0x14, 0x15
    const/4 v0, 0x0

    return v0

    :pswitch_5  #0x2, 0x5, 0x6, 0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe, 0x13
    const/4 v0, 0x3

    return v0

    :pswitch_7  #0x1, 0x3, 0x4, 0x7, 0x16
    const/4 v0, 0x2
