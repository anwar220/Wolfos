...
# static fields
.field public static final kInterfaceName:Ljava/lang/String; = "android.hardware.contexthub@1.2::IContexthub"


# direct methods
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/contexthub/V1_2/IContexthub;
    .registers 8
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/contexthub/V1_2/IContexthub;
    .registers 2
...
.method public static getService()Landroid/hardware/contexthub/V1_2/IContexthub;
    .registers 1
...
.method public static getService(Ljava/lang/String;)Landroid/hardware/contexthub/V1_2/IContexthub;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public static getService(Ljava/lang/String;Z)Landroid/hardware/contexthub/V1_2/IContexthub;
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public static getService(Z)Landroid/hardware/contexthub/V1_2/IContexthub;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public abstract getHubs_1_2(Landroid/hardware/contexthub/V1_2/IContexthub$getHubs_1_2Callback;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract onSettingChanged_1_2(BB)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract registerCallback_1_2(ILandroid/hardware/contexthub/V1_2/IContexthubCallback;)I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
